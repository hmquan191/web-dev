...
//     const appointmentQuery = 'INSERT INTO appointments (day_to_meet, id_doctor, id_patient, status) VALUES (?, ?, "pending")';
//     db.query(appointmentQuery, [dateTime, doctorId, patientId, status], (err, result) => {
//         if (err) {
